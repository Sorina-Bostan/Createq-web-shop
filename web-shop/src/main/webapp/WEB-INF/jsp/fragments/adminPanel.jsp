...
<div class="admin-panel-container">
  ...
  <div class="admin-tabs">
    <button class="admin-tab-btn active" data-target="product-management">Manage Products</button>
    <button class="admin-tab-btn" data-target="user-management">Manage Users</button>
  </div>
  <div id="product-management" class="admin-tab-content">
  ...
  <div id="user-management" class="admin-tab-content" style="display: none;">
    ...
    <button id="add-user-btn" class="admin-add-button">Add New User</button>
    ...
    <div id="add-user-form-container" style="display: none; margin-top: 20px;">
    </div>
  </div>
</div>